...
export default function AvocatDemo() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans">
      ...
      {/* Navigation */}
      <nav className="sticky top-0 z-50 bg-[#0B1A2E]/95 backdrop-blur-sm border-b border-amber-700/20">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-amber-400/60 tracking-widest uppercase">
                  Avocats au Barreau de Vaud
                </p>
              </div>
            </div>
            <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
              <a href="#domaines" className="hover:text-amber-400 transition-colors">
                Domaines
              </a>
              <a href="#equipe" className="hover:text-amber-400 transition-colors">
                L&apos;Équipe
              </a>
              <a href="#cabinet" className="hover:text-amber-400 transition-colors">
                Le Cabinet
              </a>
            ...
            <a
              href="#contact"
              className="hidden sm:inline-flex items-center px-6 py-2.5 rounded border border-amber-500 text-amber-400 text-sm font-semibold hover:bg-amber-500 hover:text-white transition-all"
            >
              Prendre rendez-vous
            </a>
          </div>
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-[#0B1A2E] min-h-[80vh] flex items-center">
        <div className="absolute inset-0 bg-gradient-to-r from-[#0B1A2E] via-[#0B1A2E] to-[#132B4A]" />
        <div className="absolute right-0 top-0 w-1/3 h-full bg-gradient-to-l from-amber-900/5 to-transparent" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <a
                href="#contact"
                className="inline-flex items-center px-8 py-4 bg-amber-500 text-white font-semibold hover:bg-amber-600 transition-colors"
              >
                Demander une consultation
              </a>
              <a
                href="#domaines"
                className="inline-flex items-center px-8 py-4 border border-gray-600 text-gray-300 font-semibold hover:border-amber-500 hover:text-amber-400 transition-colors"
              >
      ...
      <section id="domaines" className="py-20 sm:py-28 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={domain.title}
                className="flex gap-5 p-6 bg-white rounded-lg border border-gray-100 hover:border-amber-200 hover:shadow-md transition-all group"
              >
                <div className="w-14 h-14 rounded-lg bg-[#0B1A2E] flex items-center justify-center text-amber-400 shrink-0 group-hover:bg-amber-500 group-hover:text-white transition-colors">
                  {domain.icon}
                </div>
                <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={member.name} className="text-center group">
                <div className="w-44 h-52 mx-auto bg-gradient-to-b from-[#0B1A2E] to-[#132B4A] rounded-lg flex items-center justify-center mb-5 border border-gray-200 group-hover:border-amber-300 transition-colors">
                  <span className="text-4xl text-amber-400/30 font-serif">
      ...
      {/* Le Cabinet */}
      <section id="cabinet" className="py-20 sm:py-28 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Contact */}
      <section id="contact" className="py-20 sm:py-28 bg-[#0B1A2E]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">+41 21 312 56 78</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded bg-amber-500/10 border border-amber-500/20 flex items-center justify-center shrink-0">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-white font-semibold">Horaires du secrétariat</p>
                    <p className="text-gray-400 text-sm mt-1">
            ...
            <div>
              <div className="bg-white/5 border border-amber-500/10 rounded-lg p-8">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 bg-white/5 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-amber-500 rounded"
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 bg-white/5 border border-gray-700 text-white focus:outline-none focus:border-amber-500 rounded">
                  ...
                  <div>
                    ...
                    <textarea
                      className="w-full px-4 py-3 bg-white/5 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-amber-500 h-28 resize-none rounded"
                      placeholder="Décrivez brièvement votre situation..."
                    />
                  </div>
                  <button className="w-full py-3.5 bg-amber-500 text-white font-semibold hover:bg-amber-600 transition-colors rounded">
                    Envoyer ma demande
                  </button>
      ...
      <footer className="bg-[#070F1D] text-gray-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 border-2 border-amber-500/30 rounded flex items-center justify-center">
                <span className="text-amber-400/60 font-serif font-bold text-lg">R</span>
              </div>
              <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-xs text-center text-gray-600">
            <p>
